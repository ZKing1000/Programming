...
class Display:
	...
	def textGenerate(self,text): #returns images that can be blitted directly to the screen and the coords that they should be blitted at, all in a list
		...
		while 1:
			...
			for x in text:
				line += x
				if pH == textLen: #doesn't let index get out of range on line 50 
					continue
				if x == "\n": #check for new line
					lines.append(line[:-1])
					line = ""
...
bloob = 0
boomz = 0
#coords=((100,100),(500,200)),text="Hello World!",fontSize=24,fontType=None,textColor=(0,0,0),backgroundColor=(255,255,255),outlineColor=(0,0,0),outlineSize=2
scrollBar = scrollBar(((200,500),(600,700)),"Cake is a form of sweet dessert that is typically baked. In its oldest forms, cakes were modifications of breads but now cover a wide range of preparations that can be simple or elaborate and share features with other desserts such as pastries, meringues, custards and pies. Typical cake ingredients are flour, sugar, eggs, and butter or oil, with some recipes also requiring additional liquid (for example milk or water) and leavening agents (such as yeast or baking powder). Common additional flavourings include dried, candied or fresh fruit, nuts, cocoa or extracts, and numerous substitutions for the primary ingredients are possible. Cakes can also be filled with fruit preserves or dessert sauces (like pastry cream), iced with buttercream or other icings, and decorated with marzipan, piped borders, or candied fruit.[1] | I like to program. I mainly program in python, but recently I learned javascript and html so I will probably work with those a lot from now on. ",24,None,5,(0,0,0))
string = "Also known as EWF, the band was founded in Chicago by Maurice White in 1969. Other members have included Philip Bailey, Verdine White, Ralph Johnson, Larry Dunn, Al McKay and Andrew Woolfolk. The band has received 20 Grammy nominations; they won six as a group and two of its members, Maurice White and Bailey, won separate individual awards.[2] Earth, Wind & Fire have 12 American Music Awards nominations and four awards.[2] They have been inducted into the Rock and Roll Hall of Fame, the Vocal Group Hall of Fame, received a star on the Hollywood Walk of Fame, and sold over 100 million records, making them one of the world's best-selling bands of all time.[4][5][6][7][2][8] Five members of Earth, Wind & Fire were also inducted into the Songwriters Hall of Fame: Maurice White, Philip Bailey, Verdine White, Larry Dunn and Al McKay.[9] The music industry and fans have bestowed Lifetime Achievement honors from the American Society of Composers, Authors and Publishers (Rhythm & Soul Heritage Award \x80\x93 2002), NAACP (Hall of Fame 1994) and the BET Awards (Lifetime Achievement Award \x80\x93 2002).[2]"
pH = 0
while 1:
	clock.tick(30)
